...
login_url = "http://192.168.10.233:9999/DTOWebLogin"
header = {
...
r1 = s.post(url=login_url, headers=header, data=body, verify=False)
...
url2 = "http://192.168.10.233:9999/Organization/DTOAddBizEmployee"
