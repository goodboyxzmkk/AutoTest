...
public class RandomInfo {
     ...
     * @return
     */
    public static String getRandomID(Date birthStr) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
        String birth = sdf.format(birthStr);
        String id = "";
        // 随机生成省、自治区、直辖市代码 1-2
     ...
     * @return
     */
    public static Date getRandomBirth() {
        // 随机生成出生年月 7-14
     ...
     * @return
     */
    public static Date getRandomBirth(int startYear, int endYear) {
//        int startYear=startYear;  //指定随机日期开始年份
//        int endYear=endYear;     //指定随机日期开始年份(含)
    ...
    public static String getRandomSex() {
        return randomInt(2) % 2 == 0 ? "Boy" : "Girl";
    }
    ...
    public static Map getRandomInfo() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
        SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd");
        Map map = new HashMap();
        if (randomInt(2) % 2 == 0) {
            map.put("name", getRandomBoyName());
            map.put("sex", "Boy");
        } else {
            map.put("name", getRandomGirlName());
            map.put("sex", "Girl");
        }
        //获取出生年月
        Date birth = getRandomBirth(1960, 1990);
        map.put("birthday", sdf2.format(birth));
        map.put("id", getRandomID(birth));
        map.put("phone", getRandomPhone());
        map.put("age", getAge(birth));
        map.put("imno", getRandomNumber(6));
        map.put("email", getRandomQQEmail());
        map.put("address", getRandomAddress());
        Map childmap1 = new HashMap();
        if (randomInt(2) % 2 == 0) {
            childmap1.put("name", getRandomBoyName());
            childmap1.put("sex", "Boy");
        } else {
            childmap1.put("name", getRandomGirlName());
            childmap1.put("sex", "Girl");
        }
        childmap1.put("birthday", sdf2.format(getRandomBirth(1995, 2020)));
        Map childmap2 = new HashMap();
        if (randomInt(2) % 2 == 0) {
            childmap2.put("name", getRandomBoyName());
            childmap2.put("sex", "Boy");
        } else {
            childmap2.put("name", getRandomGirlName());
            childmap2.put("sex", "Girl");
        }
        childmap2.put("birthday", sdf2.format(getRandomBirth(1995, 2020)));
        map.put("child1", childmap1);
        map.put("child2", childmap2);
...
//            }
//            //身份证号
//            System.out.print("身份证: "+getRandomID()+"   ");
//            //手机号
...
//        }
        ...
        System.out.println(map.get("imno"));
        System.out.println(map.get("email"));
        System.out.println(map.get("address"));
        System.out.println(map.get("child1"));
        System.out.println(map.get("child2"));
